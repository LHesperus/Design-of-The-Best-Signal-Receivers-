...
module FIR_16_1 (
	...
	FIR_16_1_ast	FIR_16_1_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="FIR_16_1_ast" >
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, E:\tttt\FIR_16_1.txt, 3.0, -3.0, 2.0, -3.0, 1.0, 2.0, -12.0, 47.0, 96.0, -27.0, 12.0, -6.0, 1.0, 0.0, -2.0, 1.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="FIR_16_1.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_16_1_st.v, fir_16_1_constraints.tcl, fir_16_1_ast.vhd, fir_16_1.v, FIR_16_1_ast.vhd, FIR_16_1.v;
// IPFS_FILES: FIR_16_1.vo;
// =========================================================
