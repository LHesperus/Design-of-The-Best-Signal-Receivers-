...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = Fir_64_I_1_mlab_mat (stimulation, output)
	coef_matrix=[0 6 -25 54 -90 119 -125 85 -1 -95 124 -43 -90 114 24 -127 0 126 24 -115 -90 42 124 94 -1 -86 -125 -120 -90 -55 -25 -7 0 -7 -25 -55 -90 -120 -125 -86 -1 94 124 42 -90 -115 24 126 0 -127 24 114 -90 -43 124 -95 -1 85 -125 119 -90 54 -25 6 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
