...
module  aqrt2_alt_sqrt_block_pgb
	( 
	aclr,
	clken,
	clock,
...
endmodule //aqrt2_alt_sqrt_block_pgb

//synthesis_resources = lpm_add_sub 27 reg 1433 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  aqrt2_altfp_sqrt_2nc
	( 
	clock,
	data,
	result) ;
	...
	aqrt2_alt_sqrt_block_pgb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //aqrt2_altfp_sqrt_2nc
//VALID FILE
...
module aqrt2 (
	...
	aqrt2_altfp_sqrt_2nc	aqrt2_altfp_sqrt_2nc_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
