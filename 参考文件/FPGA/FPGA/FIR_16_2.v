...
module FIR_16_2 (
	...
	FIR_16_2_ast	FIR_16_2_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="FIR_16_2_ast" >
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, E:\tttt\FIR_16_2.txt, 1.0, -2.0, 0.0, 1.0, -6.0, 12.0, -27.0, 96.0, 47.0, -12.0, 2.0, 1.0, -3.0, 2.0, -3.0, 3.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="994"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="FIR_16_2.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_16_2_st.v, fir_16_2_constraints.tcl, fir_16_2_ast.vhd, fir_16_2.v, FIR_16_2_ast.vhd, FIR_16_2.v;
// IPFS_FILES: FIR_16_2.vo;
// =========================================================
