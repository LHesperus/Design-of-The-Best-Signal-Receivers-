...
%Input Data Width:	20
%FIR Width (Full Calculation Width Before Output Width Adjust) :   33
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = Fir_64_Q_1_mlab_mat (stimulation, output)
	coef_matrix=[127 -127 124 -115 89 -43 -25 94 -127 85 24 -120 89 54 -125 -7 127 6 -125 -55 89 119 24 -86 -127 -95 -25 42 89 114 124 126 127 126 124 114 89 42 -25 -95 -127 -86 24 119 89 -55 -125 6 127 -7 -125 54 89 -120 24 85 -127 94 -25 -43 89 -115 124 -127 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
