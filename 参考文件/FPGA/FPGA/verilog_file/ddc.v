...
module DDC(Clk_160, CLk_40, Rst, Prf_in, Data_in, Data_I_out, Data_Q_out, Prf_out);
   ...
   Fir_16_0 Fir_16_0_U(.clk(CLk_40), .reset_n((~Rst)), .coeff_in_clk(CLk_40), .coeff_in_areset(1'b0), .ast_sink_data(Ast_sink_data[0]), .ast_sink_ready(ast_sink_ready), .ast_sink_valid(ast_sink_valid), .ast_sink_error(2'b00), .ast_source_data(Ast_source_data[0]), .ast_source_ready(ast_source_ready), .ast_source_valid(ast_source_valid), .ast_source_error(ast_source_error));
   
   Fir_16_1 Fir_16_1_U(.clk(CLk_40), .reset_n((~Rst)), .coeff_in_clk(CLk_40), .coeff_in_areset(1'b0), .ast_sink_data(Ast_sink_data[1]), .ast_sink_ready(ast_sink_ready), .ast_sink_valid(ast_sink_valid), .ast_sink_error(2'b00), .ast_source_data(Ast_source_data[1]), .ast_source_ready(ast_source_ready), .ast_source_valid(ast_source_valid), .ast_source_error(ast_source_error));
