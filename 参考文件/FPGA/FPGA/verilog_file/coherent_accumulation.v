   ...
   begin: xhdl0
      ...
      begin
         if (Rst == 1'b1)
            for (i = 511; i >= 0; i = i - 1)
            begin
               Accumulation_I_data[i] <= 40'd0;
               Accumulation_Q_data[i] <= 40'd0;
            end
         else
            if (Prf_in == 1'b1)
               for (i = 510; i >= 0; i = i - 1)
            ...
            begin
               ...
               Accumulation_I_data[511] <= 40'd0;
               Accumulation_Q_data[511] <= 40'd0;
            end
            else if (Cont_row == 4'b1111 & Cont_line == 10'b0111111100)
            begin
               Accumulation_I_data[0] <= 40'd0;
               Accumulation_Q_data[0] <= 40'd0;
            end
            else
