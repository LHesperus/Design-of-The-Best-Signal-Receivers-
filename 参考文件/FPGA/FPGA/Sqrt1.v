...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" PIPELINE=28 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock data result
...
//alt_sqrt_block CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix II" PIPELINE=28 WIDTH_SQRT=25 aclr clken clock rad root_result
//VERSION_BEGIN 9.1 cbx_altfp_sqrt 2009:10:21:21:22:16:SJ cbx_cycloneii 2009:10:21:21:22:16:SJ cbx_lpm_add_sub 2009:10:21:21:22:16:SJ cbx_mgl 2009:10:21:21:37:49:SJ cbx_stratix 2009:10:21:21:22:16:SJ cbx_stratixii 2009:10:21:21:22:16:SJ  VERSION_END
...
module  Sqrt1_alt_sqrt_block_pgb
	( 
	aclr,
	clken,
	clock,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff0c <= 24'b0;
		else if  (clken == 1'b1)   q_ff0c <= {q_ff0c[22:0], (~ addnode_w24c[26])};
	// synopsys translate_off
	initial
		q_ff10c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff10c <= 24'b0;
		else if  (clken == 1'b1)   q_ff10c <= {q_ff10c[22:0], (~ addnode_w14c[26])};
	// synopsys translate_off
	initial
		q_ff11c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff11c <= {q_ff11c[22:0], (~ addnode_w13c[26])};
	// synopsys translate_off
	initial
		q_ff12c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff12c <= 24'b0;
		else if  (clken == 1'b1)   q_ff12c <= {q_ff12c[22:0], (~ addnode_w12c[26])};
	// synopsys translate_off
	initial
		q_ff13c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff13c <= {q_ff13c[22:0], (~ addnode_w11c[26])};
	// synopsys translate_off
	initial
		q_ff14c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff14c <= 24'b0;
		else if  (clken == 1'b1)   q_ff14c <= {q_ff14c[22:0], (~ addnode_w10c[26])};
	// synopsys translate_off
	initial
		q_ff15c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff15c <= {q_ff15c[22:0], (~ addnode_w9c[26])};
	// synopsys translate_off
	initial
		q_ff16c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff16c <= 24'b0;
		else if  (clken == 1'b1)   q_ff16c <= {q_ff16c[22:0], (~ addnode_w8c[26])};
	// synopsys translate_off
	initial
		q_ff17c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff17c <= {q_ff17c[22:0], (~ addnode_w7c[26])};
	// synopsys translate_off
	initial
		q_ff18c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff18c <= 24'b0;
		else if  (clken == 1'b1)   q_ff18c <= {q_ff18c[22:0], (~ addnode_w6c[26])};
	// synopsys translate_off
	initial
		q_ff19c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff19c <= {q_ff19c[22:0], (~ addnode_w5c[26])};
	// synopsys translate_off
	initial
		q_ff1c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff1c <= {q_ff1c[22:0], (~ addnode_w23c[26])};
	// synopsys translate_off
	initial
		q_ff20c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff20c <= 24'b0;
		else if  (clken == 1'b1)   q_ff20c <= {q_ff20c[22:0], (~ addnode_w4c[26])};
	// synopsys translate_off
	initial
		q_ff21c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff21c <= {q_ff21c[22:0], (~ addnode_w3c[26])};
	// synopsys translate_off
	initial
		q_ff22c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff22c <= 24'b0;
		else if  (clken == 1'b1)   q_ff22c <= {q_ff22c[22:0], (~ addnode_w2c[26])};
	// synopsys translate_off
	initial
		q_ff23c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff23c <= 24'b0;
		else if  (clken == 1'b1)   q_ff23c <= {q_ff23c[22:0], (~ addnode_w1c[26])};
	// synopsys translate_off
	initial
		q_ff2c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff2c <= 24'b0;
		else if  (clken == 1'b1)   q_ff2c <= {q_ff2c[22:0], (~ addnode_w22c[26])};
	// synopsys translate_off
	initial
		q_ff3c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff3c <= {q_ff3c[22:0], (~ addnode_w21c[26])};
	// synopsys translate_off
	initial
		q_ff4c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff4c <= 24'b0;
		else if  (clken == 1'b1)   q_ff4c <= {q_ff4c[22:0], (~ addnode_w20c[26])};
	// synopsys translate_off
	initial
		q_ff5c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff5c <= {q_ff5c[22:0], (~ addnode_w19c[26])};
	// synopsys translate_off
	initial
		q_ff6c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff6c <= 24'b0;
		else if  (clken == 1'b1)   q_ff6c <= {q_ff6c[22:0], (~ addnode_w18c[26])};
	// synopsys translate_off
	initial
		q_ff7c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff7c <= {q_ff7c[22:0], (~ addnode_w17c[26])};
	// synopsys translate_off
	initial
		q_ff8c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) q_ff8c <= 24'b0;
		else if  (clken == 1'b1)   q_ff8c <= {q_ff8c[22:0], (~ addnode_w16c[26])};
	// synopsys translate_off
	initial
		q_ff9c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clken == 1'b1)   q_ff9c <= {q_ff9c[22:0], (~ addnode_w15c[26])};
	// synopsys translate_off
	initial
		rad_ff0c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff0c <= 26'b0;
		else if  (clken == 1'b1)   rad_ff0c <= addnode_w0c[26:1];
	// synopsys translate_off
	initial
		rad_ff10c = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff10c <= 16'b0;
		else if  (clken == 1'b1)   rad_ff10c <= addnode_w10c[26:11];
	// synopsys translate_off
	initial
		rad_ff11c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff12c <= 14'b0;
		else if  (clken == 1'b1)   rad_ff12c <= addnode_w12c[26:13];
	// synopsys translate_off
	initial
		rad_ff13c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff14c <= 14'b0;
		else if  (clken == 1'b1)   rad_ff14c <= addnode_w14c[26:13];
	// synopsys translate_off
	initial
		rad_ff15c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff16c <= 16'b0;
		else if  (clken == 1'b1)   rad_ff16c <= addnode_w16c[26:11];
	// synopsys translate_off
	initial
		rad_ff17c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff18c <= 18'b0;
		else if  (clken == 1'b1)   rad_ff18c <= addnode_w18c[26:9];
	// synopsys translate_off
	initial
		rad_ff19c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff20c <= 20'b0;
		else if  (clken == 1'b1)   rad_ff20c <= addnode_w20c[26:7];
	// synopsys translate_off
	initial
		rad_ff21c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff22c <= 22'b0;
		else if  (clken == 1'b1)   rad_ff22c <= addnode_w22c[26:5];
	// synopsys translate_off
	initial
		rad_ff23c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff2c <= 24'b0;
		else if  (clken == 1'b1)   rad_ff2c <= addnode_w2c[26:3];
	// synopsys translate_off
	initial
		rad_ff3c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff4c <= 22'b0;
		else if  (clken == 1'b1)   rad_ff4c <= addnode_w4c[26:5];
	// synopsys translate_off
	initial
		rad_ff5c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff6c <= 20'b0;
		else if  (clken == 1'b1)   rad_ff6c <= addnode_w6c[26:7];
	// synopsys translate_off
	initial
		rad_ff7c = 0;
	// synopsys translate_on
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) rad_ff8c <= 18'b0;
		else if  (clken == 1'b1)   rad_ff8c <= addnode_w8c[26:9];
	// synopsys translate_off
	initial
		rad_ff9c = 0;
	// synopsys translate_on
	...
	.datab({(({8{(~ rad_ff6c[19])}} & (~ qlevel_w7c[9:2])) | ({8{rad_ff6c[19]}} & qlevel_w7c[9:2])), qlevel_w7c[1:0]}),
	.overflow(),
	...
	.datab({(({10{(~ rad_ff8c[17])}} & (~ qlevel_w9c[11:2])) | ({10{rad_ff8c[17]}} & qlevel_w9c[11:2])), qlevel_w9c[1:0]}),
	.overflow(),
	...
	.datab({(({12{(~ rad_ff10c[15])}} & (~ qlevel_w11c[13:2])) | ({12{rad_ff10c[15]}} & qlevel_w11c[13:2])), qlevel_w11c[1:0]}),
	.overflow(),
	...
	.datab({(({13{(~ rad_ff12c[13])}} & (~ qlevel_w13c[15:3])) | ({13{rad_ff12c[13]}} & qlevel_w13c[15:3]))}),
	.overflow(),
	...
	.datab({(({15{(~ rad_ff14c[13])}} & (~ qlevel_w15c[17:3])) | ({15{rad_ff14c[13]}} & qlevel_w15c[17:3]))}),
	.overflow(),
	...
	.datab({(({17{(~ rad_ff16c[15])}} & (~ qlevel_w17c[19:3])) | ({17{rad_ff16c[15]}} & qlevel_w17c[19:3]))}),
	.overflow(),
	...
	.datab({(({19{(~ rad_ff18c[17])}} & (~ qlevel_w19c[21:3])) | ({19{rad_ff18c[17]}} & qlevel_w19c[21:3]))}),
	.overflow(),
	...
	.datab({(({21{(~ rad_ff20c[19])}} & (~ qlevel_w21c[23:3])) | ({21{rad_ff20c[19]}} & qlevel_w21c[23:3]))}),
	.overflow(),
	...
	.datab({(({23{(~ rad_ff22c[21])}} & (~ qlevel_w23c[25:3])) | ({23{rad_ff22c[21]}} & qlevel_w23c[25:3]))}),
	.overflow(),
	...
	.datab({(({4{(~ rad_ff2c[23])}} & (~ qlevel_w3c[5:2])) | ({4{rad_ff2c[23]}} & qlevel_w3c[5:2])), qlevel_w3c[1:0]}),
	.overflow(),
	...
	.datab({(({6{(~ rad_ff4c[21])}} & (~ qlevel_w5c[7:2])) | ({6{rad_ff4c[21]}} & qlevel_w5c[7:2])), qlevel_w5c[1:0]}),
	.overflow(),
	...
	assign
		...
		qlevel_w0c = {3{1'b1}},
		qlevel_w10c = {1'b0, 1'b1, q_ff23c[8], q_ff22c[7], q_ff21c[6], q_ff20c[5], q_ff19c[4], q_ff18c[3], q_ff17c[2], q_ff16c[1], q_ff15c[0], {2{1'b1}}},
		qlevel_w11c = {1'b0, 1'b1, q_ff23c[9], q_ff22c[8], q_ff21c[7], q_ff20c[6], q_ff19c[5], q_ff18c[4], q_ff17c[3], q_ff16c[2], q_ff15c[1], q_ff14c[0], {2{1'b1}}},
		qlevel_w12c = {1'b0, 1'b1, q_ff23c[10], q_ff22c[9], q_ff21c[8], q_ff20c[7], q_ff19c[6], q_ff18c[5], q_ff17c[4], q_ff16c[3], q_ff15c[2], q_ff14c[1], q_ff13c[0], {2{1'b1}}},
		qlevel_w13c = {1'b0, 1'b1, q_ff23c[11], q_ff22c[10], q_ff21c[9], q_ff20c[8], q_ff19c[7], q_ff18c[6], q_ff17c[5], q_ff16c[4], q_ff15c[3], q_ff14c[2], q_ff13c[1], q_ff12c[0], {2{1'b1}}},
		qlevel_w14c = {1'b0, 1'b1, q_ff23c[12], q_ff22c[11], q_ff21c[10], q_ff20c[9], q_ff19c[8], q_ff18c[7], q_ff17c[6], q_ff16c[5], q_ff15c[4], q_ff14c[3], q_ff13c[2], q_ff12c[1], q_ff11c[0], {2{1'b1}}},
		qlevel_w15c = {1'b0, 1'b1, q_ff23c[13], q_ff22c[12], q_ff21c[11], q_ff20c[10], q_ff19c[9], q_ff18c[8], q_ff17c[7], q_ff16c[6], q_ff15c[5], q_ff14c[4], q_ff13c[3], q_ff12c[2], q_ff11c[1], q_ff10c[0], {2{1'b1}}},
		qlevel_w16c = {1'b0, 1'b1, q_ff23c[14], q_ff22c[13], q_ff21c[12], q_ff20c[11], q_ff19c[10], q_ff18c[9], q_ff17c[8], q_ff16c[7], q_ff15c[6], q_ff14c[5], q_ff13c[4], q_ff12c[3], q_ff11c[2], q_ff10c[1], q_ff9c[0], {2{1'b1}}},
		qlevel_w17c = {1'b0, 1'b1, q_ff23c[15], q_ff22c[14], q_ff21c[13], q_ff20c[12], q_ff19c[11], q_ff18c[10], q_ff17c[9], q_ff16c[8], q_ff15c[7], q_ff14c[6], q_ff13c[5], q_ff12c[4], q_ff11c[3], q_ff10c[2], q_ff9c[1], q_ff8c[0], {2{1'b1}}},
		qlevel_w18c = {1'b0, 1'b1, q_ff23c[16], q_ff22c[15], q_ff21c[14], q_ff20c[13], q_ff19c[12], q_ff18c[11], q_ff17c[10], q_ff16c[9], q_ff15c[8], q_ff14c[7], q_ff13c[6], q_ff12c[5], q_ff11c[4], q_ff10c[3], q_ff9c[2], q_ff8c[1], q_ff7c[0], {2{1'b1}}},
		qlevel_w19c = {1'b0, 1'b1, q_ff23c[17], q_ff22c[16], q_ff21c[15], q_ff20c[14], q_ff19c[13], q_ff18c[12], q_ff17c[11], q_ff16c[10], q_ff15c[9], q_ff14c[8], q_ff13c[7], q_ff12c[6], q_ff11c[5], q_ff10c[4], q_ff9c[3], q_ff8c[2], q_ff7c[1], q_ff6c[0], {2{1'b1}}},
		qlevel_w1c = {1'b1, 1'b0, {2{1'b1}}},
		qlevel_w20c = {1'b0, 1'b1, q_ff23c[18], q_ff22c[17], q_ff21c[16], q_ff20c[15], q_ff19c[14], q_ff18c[13], q_ff17c[12], q_ff16c[11], q_ff15c[10], q_ff14c[9], q_ff13c[8], q_ff12c[7], q_ff11c[6], q_ff10c[5], q_ff9c[4], q_ff8c[3], q_ff7c[2], q_ff6c[1], q_ff5c[0], {2{1'b1}}},
		qlevel_w21c = {1'b0, 1'b1, q_ff23c[19], q_ff22c[18], q_ff21c[17], q_ff20c[16], q_ff19c[15], q_ff18c[14], q_ff17c[13], q_ff16c[12], q_ff15c[11], q_ff14c[10], q_ff13c[9], q_ff12c[8], q_ff11c[7], q_ff10c[6], q_ff9c[5], q_ff8c[4], q_ff7c[3], q_ff6c[2], q_ff5c[1], q_ff4c[0], {2{1'b1}}},
		qlevel_w22c = {1'b0, 1'b1, q_ff23c[20], q_ff22c[19], q_ff21c[18], q_ff20c[17], q_ff19c[16], q_ff18c[15], q_ff17c[14], q_ff16c[13], q_ff15c[12], q_ff14c[11], q_ff13c[10], q_ff12c[9], q_ff11c[8], q_ff10c[7], q_ff9c[6], q_ff8c[5], q_ff7c[4], q_ff6c[3], q_ff5c[2], q_ff4c[1], q_ff3c[0], {2{1'b1}}},
		qlevel_w23c = {1'b0, 1'b1, q_ff23c[21], q_ff22c[20], q_ff21c[19], q_ff20c[18], q_ff19c[17], q_ff18c[16], q_ff17c[15], q_ff16c[14], q_ff15c[13], q_ff14c[12], q_ff13c[11], q_ff12c[10], q_ff11c[9], q_ff10c[8], q_ff9c[7], q_ff8c[6], q_ff7c[5], q_ff6c[4], q_ff5c[3], q_ff4c[2], q_ff3c[1], q_ff2c[0], {2{1'b1}}},
		qlevel_w24c = {(~ rad_ff23c[22]), rad_ff23c[22], q_ff23c[22], q_ff22c[21], q_ff21c[20], q_ff20c[19], q_ff19c[18], q_ff18c[17], q_ff17c[16], q_ff16c[15], q_ff15c[14], q_ff14c[13], q_ff13c[12], q_ff12c[11], q_ff11c[10], q_ff10c[9], q_ff9c[8], q_ff8c[7], q_ff7c[6], q_ff6c[5], q_ff5c[4], q_ff4c[3], q_ff3c[2], q_ff2c[1], q_ff1c[0], {2{1'b1}}},
		qlevel_w2c = {1'b0, 1'b1, q_ff23c[0], {2{1'b1}}},
		qlevel_w3c = {1'b0, 1'b1, q_ff23c[1], q_ff22c[0], {2{1'b1}}},
		qlevel_w4c = {1'b0, 1'b1, q_ff23c[2], q_ff22c[1], q_ff21c[0], {2{1'b1}}},
		qlevel_w5c = {1'b0, 1'b1, q_ff23c[3], q_ff22c[2], q_ff21c[1], q_ff20c[0], {2{1'b1}}},
		qlevel_w6c = {1'b0, 1'b1, q_ff23c[4], q_ff22c[3], q_ff21c[2], q_ff20c[1], q_ff19c[0], {2{1'b1}}},
		qlevel_w7c = {1'b0, 1'b1, q_ff23c[5], q_ff22c[4], q_ff21c[3], q_ff20c[2], q_ff19c[1], q_ff18c[0], {2{1'b1}}},
		qlevel_w8c = {1'b0, 1'b1, q_ff23c[6], q_ff22c[5], q_ff21c[4], q_ff20c[3], q_ff19c[2], q_ff18c[1], q_ff17c[0], {2{1'b1}}},
		qlevel_w9c = {1'b0, 1'b1, q_ff23c[7], q_ff22c[6], q_ff21c[5], q_ff20c[4], q_ff19c[3], q_ff18c[2], q_ff17c[1], q_ff16c[0], {2{1'b1}}},
		root_result = {1'b1, q_ff23c[23], q_ff22c[22], q_ff21c[21], q_ff20c[20], q_ff19c[19], q_ff18c[18], q_ff17c[17], q_ff16c[16], q_ff15c[15], q_ff14c[14], q_ff13c[13], q_ff12c[12], q_ff11c[11], q_ff10c[10], q_ff9c[9], q_ff8c[8], q_ff7c[7], q_ff6c[6], q_ff5c[5], q_ff4c[4], q_ff3c[3], q_ff2c[2], q_ff1c[1], q_ff0c[0]},
		slevel_w0c = {1'b0, rad},
		slevel_w10c = {rad_ff9c[15:0], {11{1'b0}}},
		slevel_w11c = {rad_ff10c[14:0], {12{1'b0}}},
		slevel_w12c = {rad_ff11c[13:0], {13{1'b0}}},
		slevel_w13c = {rad_ff12c[12:0], 1'b1, {13{1'b0}}},
		slevel_w14c = {rad_ff13c[11:0], {3{1'b1}}, {12{1'b0}}},
		slevel_w15c = {rad_ff14c[12:0], {3{1'b1}}, {11{1'b0}}},
		slevel_w16c = {rad_ff15c[13:0], {3{1'b1}}, {10{1'b0}}},
		slevel_w17c = {rad_ff16c[14:0], {3{1'b1}}, {9{1'b0}}},
		slevel_w18c = {rad_ff17c[15:0], {3{1'b1}}, {8{1'b0}}},
		slevel_w19c = {rad_ff18c[16:0], {3{1'b1}}, {7{1'b0}}},
		slevel_w1c = {rad_ff0c[24:0], {2{1'b0}}},
		slevel_w20c = {rad_ff19c[17:0], {3{1'b1}}, {6{1'b0}}},
		slevel_w21c = {rad_ff20c[18:0], {3{1'b1}}, {5{1'b0}}},
		slevel_w22c = {rad_ff21c[19:0], {3{1'b1}}, {4{1'b0}}},
		slevel_w23c = {rad_ff22c[20:0], {3{1'b1}}, {3{1'b0}}},
		slevel_w24c = {rad_ff23c[21:0], {3{1'b1}}, {2{1'b0}}},
		slevel_w2c = {rad_ff1c[23:0], {3{1'b0}}},
		slevel_w3c = {rad_ff2c[22:0], {4{1'b0}}},
		slevel_w4c = {rad_ff3c[21:0], {5{1'b0}}},
		slevel_w5c = {rad_ff4c[20:0], {6{1'b0}}},
		slevel_w6c = {rad_ff5c[19:0], {7{1'b0}}},
		slevel_w7c = {rad_ff6c[18:0], {8{1'b0}}},
		slevel_w8c = {rad_ff7c[17:0], {9{1'b0}}},
		slevel_w9c = {rad_ff8c[16:0], {10{1'b0}}};
endmodule //Sqrt1_alt_sqrt_block_pgb

//synthesis_resources = lpm_add_sub 27 reg 1433 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Sqrt1_altfp_sqrt_2nc
	( 
	clock,
	data,
	result) ;
	...
	Sqrt1_alt_sqrt_block_pgb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   exp_result_ff <= (((exp_ff2_w & {8{zero_exp_ff24[0:0]}}) | {8{nan_man_ff24[0:0]}}) | {8{infinity_ff24[0:0]}});
	// synopsys translate_off
	initial
		infinity_ff0 = 0;
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else if  (clk_en == 1'b1)   man_result_ff <= ((man_rounding_ff & {23{zero_exp_ff24[0:0]}}) | {23{nan_man_ff24[0:0]}});
	// synopsys translate_off
	initial
		man_rounding_ff = 0;
	// synopsys translate_on
	...
	assign
		...
		result = {sign_node_ff27[0:0], exp_result_ff, man_result_ff},
		roundbit_w = wire_alt_sqrt_block2_root_result[0];
endmodule //Sqrt1_altfp_sqrt_2nc
//VALID FILE
...
module Sqrt1 (
	...
	Sqrt1_altfp_sqrt_2nc	Sqrt1_altfp_sqrt_2nc_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
