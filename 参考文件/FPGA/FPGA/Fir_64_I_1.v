...
module Fir_64_I_1 (
	...
	Fir_64_I_1_ast	Fir_64_I_1_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="Fir_64_I_1_ast" >
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, E:\tttt\Fir_64_0.txt, 0.0, 6.0, -25.0, 54.0, -90.0, 119.0, -125.0, 85.0, -1.0, -95.0, 124.0, -43.0, -90.0, 114.0, 24.0, -127.0, 0.0, 126.0, 24.0, -115.0, -90.0, 42.0, 124.0, 94.0, -1.0, -86.0, -125.0, -120.0, -90.0, -55.0, -25.0, -7.0, 0.0, -7.0, -25.0, -55.0, -90.0, -120.0, -125.0, -86.0, -1.0, 94.0, 124.0, 42.0, -90.0, -115.0, 24.0, 126.0, 0.0, -127.0, 24.0, 114.0, -90.0, -43.0, 124.0, -95.0, -1.0, 85.0, -125.0, 119.0, -90.0, 54.0, -25.0, 6.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="6031"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="Fir_64_I_1.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_64_i_1_st.v, fir_64_i_1_constraints.tcl, fir_64_i_1_ast.vhd, fir_64_i_1.v, Fir_64_I_1_ast.vhd, Fir_64_I_1.v;
// IPFS_FILES: Fir_64_I_1.vo;
// =========================================================
