...
%Input Data Width:	14
%LSB Truncated bits:%LSB Rounded bits  :17
%FIR Width (Full Calculation Width Before Output Width Adjust) :   31
%-----------------------------------------------------------------------------------------------------------

	%MegaWizard Scaled Coefficient Values
	function  output = FIR2_mlab_mat (stimulation, output)
	coef_matrix=[-9 -492 -1512 -1135 1148 996 -2161 -678 4008 -721 -7695 6715 32767 32767 6715 -7695 -721 4008 -678 -2161 996 1148 -1135 -1512 -492 -9 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
