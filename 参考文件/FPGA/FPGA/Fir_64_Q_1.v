...
module Fir_64_Q_1 (
	...
	Fir_64_Q_1_ast	Fir_64_Q_1_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="Fir_64_Q_1_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_bit_width" value="8"  type="INTEGER"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "input_bit_width" value="20"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "output_bit_width" value="33"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, E:\tttt\Fir_64_1.txt, 127.0, -127.0, 124.0, -115.0, 89.0, -43.0, -25.0, 94.0, -127.0, 85.0, 24.0, -120.0, 89.0, 54.0, -125.0, -7.0, 127.0, 6.0, -125.0, -55.0, 89.0, 119.0, 24.0, -86.0, -127.0, -95.0, -25.0, 42.0, 89.0, 114.0, 124.0, 126.0, 127.0, 126.0, 124.0, 114.0, 89.0, 42.0, -25.0, -95.0, -127.0, -86.0, 24.0, 119.0, 89.0, -55.0, -125.0, 6.0, 127.0, -7.0, -125.0, 54.0, 89.0, -120.0, 24.0, 85.0, -127.0, 94.0, -25.0, -43.0, 89.0, -115.0, 124.0, -127.0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "number_of_sets" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_full_bit_width" value="33"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="6329"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="Fir_64_Q_1.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_64_q_1_st.v, fir_64_q_1_constraints.tcl, fir_64_q_1_ast.vhd, fir_64_q_1.v, Fir_64_Q_1_ast.vhd, Fir_64_Q_1.v;
// IPFS_FILES: Fir_64_Q_1.vo;
// =========================================================
