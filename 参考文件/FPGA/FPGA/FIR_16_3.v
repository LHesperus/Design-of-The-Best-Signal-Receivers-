...
module FIR_16_3 (
	...
	FIR_16_3_ast	FIR_16_3_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="FIR_16_3_ast" >
...
// Retrieval info:      <PRIVATE name = "output_bit_width" value="20"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, E:\tttt\FIR_16_3.txt, -1.0, 1.0, -4.0, 6.0, -11.0, 15.0, -24.0, 127.0, 2.0, 5.0, -8.0, 6.0, -5.0, 3.0, -2.0, -1.0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "number_of_sets" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_full_bit_width" value="20"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="1006"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="FIR_16_3.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_16_3_st.v, fir_16_3_constraints.tcl, fir_16_3_ast.vhd, fir_16_3.v, FIR_16_3_ast.vhd, FIR_16_3.v;
// IPFS_FILES: FIR_16_3.vo;
// =========================================================
