...
module  Sqrt_alt_sqrt_block_pgb
	( 
	aclr,
	clken,
	clock,
...
endmodule //Sqrt_alt_sqrt_block_pgb

//synthesis_resources = lpm_add_sub 27 reg 1433 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Sqrt_altfp_sqrt_2nc
	( 
	clock,
	data,
	result) ;
	...
	Sqrt_alt_sqrt_block_pgb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
module Sqrt (
	...
	Sqrt_altfp_sqrt_2nc	Sqrt_altfp_sqrt_2nc_component (
				.clock (clock),
				.data (data),
				.result (sub_wire0));
