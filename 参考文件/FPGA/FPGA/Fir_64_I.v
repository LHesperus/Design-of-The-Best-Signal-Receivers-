...
module Fir_64_I (
	...
	Fir_64_I_ast	Fir_64_I_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="Fir_64_I_ast" >
...
// Retrieval info:      <PRIVATE name = "filename" value="Fir_64_I.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_64_i_st.v, fir_64_i_constraints.tcl, fir_64_i_ast.vhd, fir_64_i.v, Fir_64_I_ast.vhd, Fir_64_I.v;
// IPFS_FILES: Fir_64_I.vo;
// =========================================================
