...
module Fir_64_Q (
	...
	Fir_64_Q_ast	Fir_64_Q_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="Fir_64_Q_ast" >
...
// Retrieval info:      <PRIVATE name = "filename" value="Fir_64_Q.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fir_64_q_st.v, fir_64_q_constraints.tcl, fir_64_q_ast.vhd, fir_64_q.v, Fir_64_Q_ast.vhd, Fir_64_Q.v;
// IPFS_FILES: Fir_64_Q.vo;
// =========================================================
