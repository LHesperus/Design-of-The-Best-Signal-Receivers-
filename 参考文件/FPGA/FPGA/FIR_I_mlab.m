...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = FIR_I_mlab_mat (stimulation, output)
	coef_matrix=[-2 -2 2 2 -2 -2 2 2 -2 -2 2 3 -3 -3 3 3 -4 -4 4 5 -5 -6 6 7 -8 -9 11 14 -18 -25 42 127 127 42 -25 -18 14 11 -9 -8 7 6 -6 -5 5 4 -4 -4 3 3 -3 -3 3 2 -2 -2 2 2 -2 -2 2 2 -2 -2 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
