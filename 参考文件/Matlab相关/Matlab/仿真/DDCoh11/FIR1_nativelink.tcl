...
catch {set coef_files [glob -nocomplain FIR1_coef*.txt]} error_msg
puts "$error_msg"
  
# The top-level in HDL type "VHDL"
set ipfs_ext vho
if {[file exists FIR1.vho]} {
	set hdl_ext vhd
} else {
	puts "Warning: Could not find FIR1.$ipfs_ext!"
}
...
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.tb_FIR1 -section_id tb
set_global_assignment -name EDA_TEST_BENCH_GATE_LEVEL_NETLIST_LIBRARY work -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE FIR1.$ipfs_ext -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE FIR1_input.txt -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_FILE tb_FIR1.vhd -section_id tb -library work
