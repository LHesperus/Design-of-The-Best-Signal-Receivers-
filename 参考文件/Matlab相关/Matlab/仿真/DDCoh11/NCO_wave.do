...
add wave -noupdate -color Yellow -format Analog-Step -radix decimal -scale 0.0040 /NCO_tb/sin_val
add wave -noupdate -divider -height 80 {New Divider}
add wave -noupdate -color Cyan -format Analog-Step -radix decimal -scale 0.0040 /NCO_tb/cos_val
