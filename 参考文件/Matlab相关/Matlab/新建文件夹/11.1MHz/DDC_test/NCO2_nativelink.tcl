...
set ipfs_ext "vo"
if {[file exists NCO2.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find NCO2.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NCO2_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.NCO2_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "NCO2.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "NCO2_tb.${hdl_ext}" -section_id tb -library work

set_global_assignment -name EDA_TEST_BENCH_RUN_SIM_FOR 22000 -section_id tb -library work
