...
%-----------------------------------------------------------------------------------------------------------
	...
	coef_matrix=[23 24 0 -31 -37 0 55 67 0 -97 -117 0 164 193 0 -263 -304 0 406 467 0 -621 -718 0 976 1154 0 -1706 -2176 0 4471 9001 10908 9001 4471 0 -2176 -1706 0 1154 976 0 -718 -621 0 467 406 0 -304 -263 0 193 164 0 -117 -97 0 67 55 0 -37 -31 0 24 23 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
